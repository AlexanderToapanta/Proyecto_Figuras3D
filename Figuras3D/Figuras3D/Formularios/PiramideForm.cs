...
namespace Figuras3D.Formularios
{
    public partial class PiramideForm : Form
    {
        ...
        public PiramideForm()
        {
            ...
            // Inicializar pirámide con material por defecto
            piramide = new Piramide("Pirámide Morada");
            piramide.ColorFigura = Color.Purple;
            piramide.Material = Material.CrearPlastico(Color.Purple);
            piramide.Iluminacion = Iluminacion.CrearIluminacionEstudio();
            
            // GUARDAR color original
            colorOriginalFigura = Color.Purple;
        ...
        private void panelVisualizacion_Paint(object sender, PaintEventArgs e)
        {
            ...
            motorRenderizado.RenderizarFigura(g, piramide, panelVisualizacion.Width, panelVisualizacion.Height);
        ...
        private void ComboBoxTextura_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            piramide.Material.Textura = tipoTextura;
            panelVisualizacion.Invalidate();
        }
        ...
        private void ComboBoxMaterial_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            TipoTextura texturaActual = piramide.Material.Textura;
            Color colorSecundario = piramide.Material.ColorSecundario;
            float escalaTextura = piramide.Material.EscalaTextura;
            
            // Aplicar material predefinido según selección
            switch (comboMaterial.SelectedIndex)
            {
                case 0: // Plástico
                    piramide.Material = Material.CrearPlastico(colorOriginalFigura);
                    piramide.Material.ColorDifuso = colorOriginalFigura;
                    break;
                case 1: // Metálico
                    piramide.Material = Material.CrearMetalico(colorOriginalFigura);
                    piramide.Material.ColorDifuso = colorOriginalFigura;
                    break;
                case 2: // Vidrio
                    piramide.Material = Material.CrearVidrio(colorOriginalFigura);
                    piramide.Material.ColorDifuso = colorOriginalFigura;
                    break;
                case 3: // Oro
                    piramide.Material = Material.CrearOro(colorOriginalFigura);
                    // El oro usa su propio color dorado, NO restauramos el original
                    break;
            }
            
            // RESTAURAR la textura y propiedades que tenía antes
            piramide.Material.Textura = texturaActual;
            piramide.Material.ColorSecundario = colorSecundario;
            piramide.Material.EscalaTextura = escalaTextura;
        ...
        {
            colorDialog1.Color = piramide.Material.ColorDifuso;
            if (colorDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                piramide.Material.ColorDifuso = colorDialog1.Color;
                panelVisualizacion.Invalidate();
            }
        }
        ...
        private void CambiarCamara(TipoCamara tipo)
        {
            ...
            switch (tipo)
            {
                ...
                case TipoCamara.Lateral:
                    ...
                    piramide.Rotacion = new Point3D(0, 90, 0);
                    break;
            ...
            numericRotacionX.Value = (decimal)(piramide.Rotacion.X % 360);
            numericRotacionY.Value = (decimal)(piramide.Rotacion.Y % 360);
            numericRotacionZ.Value = (decimal)(piramide.Rotacion.Z % 360);
