...
namespace Figuras3D.Formularios
{
    public partial class CuboForm : Form
    {
        ...
        public CuboForm()
        {
            ...
            cubo.Iluminacion = Iluminacion.CrearIluminacionEstudio();
            
            // GUARDAR color original
            colorOriginalFigura = Color.Blue;
        ...
        private void panelVisualizacion_Paint(object sender, PaintEventArgs e)
        {
            ...
            motorRenderizado.RenderizarFigura(g, cubo, panelVisualizacion.Width, panelVisualizacion.Height);
        ...
        private void ComboBoxTextura_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cubo.Material.Textura = tipoTextura;
            panelVisualizacion.Invalidate();
        }
        ...
        private void ComboBoxMaterial_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            TipoTextura texturaActual = cubo.Material.Textura;
            Color colorSecundario = cubo.Material.ColorSecundario;
            float escalaTextura = cubo.Material.EscalaTextura;
            
            // Aplicar material predefinido según selección
            switch (comboMaterial.SelectedIndex)
            {
                case 0: // Plástico
                    cubo.Material = Material.CrearPlastico(colorOriginalFigura);
                    cubo.Material.ColorDifuso = colorOriginalFigura;
                    break;
                case 1: // Metálico
                    cubo.Material = Material.CrearMetalico(colorOriginalFigura);
                    cubo.Material.ColorDifuso = colorOriginalFigura;
                    break;
                case 2: // Vidrio
                    cubo.Material = Material.CrearVidrio(colorOriginalFigura);
                    cubo.Material.ColorDifuso = colorOriginalFigura;
                    break;
                case 3: // Oro
                    cubo.Material = Material.CrearOro(colorOriginalFigura);
                    // El oro usa su propio color dorado, NO restauramos el original
                    break;
            }
            
            // RESTAURAR la textura y propiedades que tenía antes
            cubo.Material.Textura = texturaActual;
            cubo.Material.ColorSecundario = colorSecundario;
            cubo.Material.EscalaTextura = escalaTextura;
        ...
        {
            colorDialog1.Color = cubo.Material.ColorDifuso;
            if (colorDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                cubo.Material.ColorDifuso = colorDialog1.Color;
                panelVisualizacion.Invalidate();
            }
        }
        ...
        private void CambiarCamara(TipoCamara tipo)
        {
            ...
            switch (tipo)
            {
                ...
                case TipoCamara.Lateral:
                    ...
                    cubo.Rotacion = new Point3D(0, 90, 0);
                    break;
            ...
            numericRotacionX.Value = (decimal)(cubo.Rotacion.X % 360);
            numericRotacionY.Value = (decimal)(cubo.Rotacion.Y % 360);
            numericRotacionZ.Value = (decimal)(cubo.Rotacion.Z % 360);
